...
const THEMES = {
  ...
  sports: [
    "GOALS", "TEAMS", "SCORE", "LEAGU", "SEASON",
    "TITLE", "CHAMP", "COACH", "REFER", "PENAL",
    "OFFSI", "CROSS", "SWING", "DRILL", "CLIMB",
    "RUNUP", "LONGJ", "HIGHJ", "VAULT", "BREAK",
    "SPINS", "FLIPS", "TURNS", "DRIBB", "THROW",
  ],
  foods: [
    "PIZZA", "SUSHI", "TACOS", "NAAN", "RICE",
    "PASTA", "BREAD", "CHEES", "STEAK", "SALAD",
    "SOUP", "FRIES", "WAFFL", "PANCA", "OATME",
    "YOGURT", "APPLES", "BANAN", "GRAPE", "LEMON",
    "MANGO", "PEACH", "MELON", "ONION", "BACON",
    "SAUCE", "ROAST", "GRILL", "STEAM", "FRY",
  ],
  animals: [
    "TIGER", "LIONS", "EAGLE", "SHARK", "WHALE",
    "DOLPH", "HORSE", "ZEBRA", "PANDA", "KOALA",
    "GIRAFF", "RHINO", "HIPPO", "CROCO", "SNAKE",
    "LIZARD", "TURTL", "RABBIT", "SQUIR", "FOX",
    "WOLF", "BEAR", "DEER", "DUCK", "GOOSE",
    "HAWKS", "OWL", "CROW", "DOVE", "SWAN",
  ],
};
